...
class CommTrackUI(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        package_manager_action = QAction("Package Manager", self)
        home_menu.addAction(package_manager_action)
        package_manager_action.triggered.connect(self.open_packagemanager_ui)
    ...
    def create_tab_widget(self):
        ...
        button_layout.addWidget(self.generate_map_button)
